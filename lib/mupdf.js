...
exports.PDFWidget = exports.PDFAnnotation = exports.PDFGraftMap = exports.PDFDocument = exports.Document = exports.DocumentWriter = exports.DisplayListDevice = exports.DrawDevice = exports.Device = exports.StructuredText = exports.Shade = exports.Pixmap = exports.DisplayList = exports.Text = exports.Path = exports.StrokeState = exports.Image = exports.Font = exports.ColorSpace = exports.Buffer = exports.Rect = exports.Matrix = exports.setUserCSS = exports.disableICC = exports.enableICC = void 0;
...
class ColorSpace extends Userdata {
    constructor(from, name) {
        ...
        if (from instanceof Buffer)
            pointer = libmupdf._wasm_new_icc_colorspace(STRING(name), from.pointer);
        super(pointer);
    }
    getName() {
...
class Font extends Userdata {
    constructor(name_or_pointer, buffer, subfont = 0) {
        let pointer = 0;
...
PDFAnnotation.LINE_ENDING_NONE = 0;
PDFAnnotation.LINE_ENDING_SQUARE = 1;
PDFAnnotation.LINE_ENDING_CIRCLE = 2;
PDFAnnotation.LINE_ENDING_DIAMOND = 3;
PDFAnnotation.LINE_ENDING_OPEN_ARROW = 4;
PDFAnnotation.LINE_ENDING_CLOSED_ARROW = 5;
PDFAnnotation.LINE_ENDING_BUTT = 6;
PDFAnnotation.LINE_ENDING_R_OPEN_ARROW = 7;
PDFAnnotation.LINE_ENDING_R_CLOSED_ARROW = 8;
PDFAnnotation.LINE_ENDING_SLASH = 9;
PDFAnnotation.BORDER_STYLE = ["Solid", "Dashed", "Beveled", "Inset", "Underline"];
PDFAnnotation.BORDER_STYLE_SOLID = 0;
PDFAnnotation.BORDER_STYLE_DASHED = 1;
PDFAnnotation.BORDER_STYLE_BEVELED = 2;
PDFAnnotation.BORDER_STYLE_INSET = 3;
PDFAnnotation.BORDER_STYLE_UNDERLINE = 4;
PDFAnnotation.BORDER_EFFECT = ["None", "Cloudy"];
PDFAnnotation.BORDER_EFFECT_NONE = 0;
PDFAnnotation.BORDER_EFFECT_CLOUDY = 1;
