...
class PDFDocument extends Document {
    ...
    static openDocument(from) {
        return Document.openDocument(from, "application/pdf");
    }
    loadPage(index) {
