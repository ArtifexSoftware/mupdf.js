...
exports.Stream = exports.PDFWidget = exports.PDFAnnotation = exports.PDFGraftMap = exports.PDFObject = exports.PDFPage = exports.PDFDocument = exports.Page = exports.Link = exports.OutlineIterator = exports.Document = exports.DocumentWriter = exports.DisplayListDevice = exports.DrawDevice = exports.Device = exports.StructuredText = exports.Shade = exports.Pixmap = exports.DisplayList = exports.Text = exports.Path = exports.StrokeState = exports.Image = exports.Font = exports.ColorSpace = exports.Buffer = exports.Rect = exports.Matrix = exports.setUserCSS = exports.disableICC = exports.enableICC = exports.AbortError = exports.TryLaterError = void 0;
...
exports.Rect = {
    ...
    isInfinite: function (rect) {
        checkRect(rect);
        return (rect[0] === exports.Rect.MIN_INF_RECT &&
            rect[1] === exports.Rect.MIN_INF_RECT &&
            rect[2] === exports.Rect.MAX_INF_RECT &&
            rect[3] === exports.Rect.MAX_INF_RECT);
    },
    transform: function (rect, matrix) {
        checkRect(rect);
        checkMatrix(matrix);
        var t;
        if (exports.Rect.isInfinite(rect))
            return rect;
        if (!exports.Rect.isValid(rect))
            return rect;
...
class Buffer extends Userdata {
    static _drop = libmupdf._wasm_drop_buffer;
    constructor(arg) {
...
class ColorSpace extends Userdata {
    static _drop = libmupdf._wasm_drop_colorspace;
    static COLORSPACE_TYPES = [
        "None",
        "Gray",
        "RGB",
        "BGR",
    ...
    static DeviceGray = new ColorSpace(libmupdf._wasm_device_gray());
    static DeviceRGB = new ColorSpace(libmupdf._wasm_device_rgb());
    static DeviceBGR = new ColorSpace(libmupdf._wasm_device_bgr());
    static DeviceCMYK = new ColorSpace(libmupdf._wasm_device_cmyk());
    static Lab = new ColorSpace(libmupdf._wasm_device_lab());
}
exports.ColorSpace = ColorSpace;
class Font extends Userdata {
    static _drop = libmupdf._wasm_drop_font;
    static SIMPLE_ENCODING = [
        "Latin",
        "Greek",
        "Cyrillic"
    ];
...
class Image extends Userdata {
    static _drop = libmupdf._wasm_drop_image;
...
class StrokeState extends Userdata {
    static _drop = libmupdf._wasm_drop_stroke_state;
    static LINE_CAP = [
        "Butt",
        "Round",
        "Squade",
...
class Path extends Userdata {
    static _drop = libmupdf._wasm_drop_path;
    constructor(pointer) {
        if (typeof pointer === "number")
            super(pointer);
        else
...
class Text extends Userdata {
    static _drop = libmupdf._wasm_drop_text;
    constructor(pointer) {
        if (typeof pointer === "number")
            super(pointer);
        else
    ...
    showString(font, trm, str, wmode = 0) {
        ...
        let out_trm = fromMatrix(libmupdf._wasm_show_string(this.pointer, font.pointer, MATRIX(trm), STRING(str), wmode));
        trm[4] = out_trm[4];
        trm[5] = out_trm[5];
    }
    walk(_walker) {
...
class DisplayList extends Userdata {
    static _drop = libmupdf._wasm_drop_display_list;
    constructor(arg1) {
        let pointer = 0;
        if (typeof arg1 === "number") {
            pointer = arg1;
...
class Pixmap extends Userdata {
    static _drop = libmupdf._wasm_drop_pixmap;
...
class Shade extends Userdata {
    static _drop = libmupdf._wasm_drop_shade;
    constructor(pointer) {
        super(pointer);
    }
    getBounds() {
...
class StructuredText extends Userdata {
    static _drop = libmupdf._wasm_drop_stext_page;
...
class Device extends Userdata {
    static _drop = libmupdf._wasm_drop_device;
    static BLEND_MODES = [
        "Normal",
        "Multiply",
        "Screen",
...
exports.DisplayListDevice = DisplayListDevice;
// === DocumentWriter ===
class DocumentWriter extends Userdata {
    static _drop = libmupdf._wasm_drop_document_writer;
...
class Document extends Userdata {
    static _drop = libmupdf._wasm_drop_document;
...
class OutlineIterator extends Userdata {
    static _drop = libmupdf._wasm_drop_outline_iterator;
    item() {
...
exports.OutlineIterator = OutlineIterator;
class Link extends Userdata {
    static _drop = libmupdf._wasm_drop_link;
    getBounds() {
...
class Page extends Userdata {
    static _drop = libmupdf._wasm_drop_page;
    isPDF() {
...
class PDFDocument extends Document {
    ...
    addPage(mediabox, rotate, resources, contents) {
        ...
        return this._fromPDFObjectNew(libmupdf._wasm_pdf_add_page(this, RECT(mediabox), rotate, this._PDFOBJ(resources), BUFFER(contents)));
    }
    insertPage(at, obj) {
        checkType(at, "number");
...
class PDFPage extends Page {
    ...
    toPixmap(matrix, colorspace, alpha = false, showExtras = true, usage = "View", box = "CropBox") {
        ...
        let result;
        if (showExtras)
            result = libmupdf._wasm_pdf_new_pixmap_from_page_with_usage(this, MATRIX(matrix), colorspace.pointer, alpha, STRING(usage), box);
        else
            result = libmupdf._wasm_pdf_new_pixmap_from_page_contents_with_usage(this, MATRIX(matrix), colorspace.pointer, alpha, STRING(usage), box);
        return new Pixmap(result);
    }
    getWidgets() {
        if (!this._widgets) {
...
class PDFObject extends Userdata {
    static _drop = libmupdf._wasm_pdf_drop_obj;
    static Null = new PDFObject(null, 0);
    _doc;
    // PRIVATE
    constructor(doc, pointer) {
...
class PDFGraftMap extends Userdata {
    static _drop = libmupdf._wasm_pdf_drop_graft_map;
    _doc;
    // PRIVATE
    constructor(doc, pointer) {
        super(pointer);
...
exports.PDFGraftMap = PDFGraftMap;
class PDFAnnotation extends Userdata {
    static _drop = libmupdf._wasm_pdf_drop_annot;
    _doc;
    ...
    getType() {
        ...
        return PDFAnnotation.ANNOT_TYPES[type];
    }
    getLanguage() {
...
exports.PDFWidget = PDFWidget;
class Stream extends Userdata {
    static _drop = libmupdf._wasm_drop_stream;
